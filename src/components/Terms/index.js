            ...
            <div style={this.style} className="row">
                <div className="col-md-12">
                    ...
                    <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the
                        https://tech-corner.netlify.com/ website (the "Service") operated by Tech Corner! ("us", "we",
                        or
                        "our").</p>
                    ...
                    <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any
                        part
                        of the terms then you may not access the Service. This Terms of Service agreement for Tech
                        Corner!
                        is managed by <a href="https://termsfeed.com/terms-conditions/generator/">the Terms and
                            Conditions
                            Generator</a>.</p>
                    ...
                    <p>Tech Corner! has no control over, and assumes no responsibility for, the content, privacy
                        policies,
                        or practices of any third party web sites or services. You further acknowledge and agree that
                        Tech
                        Corner! shall not be responsible or liable, directly or indirectly, for any damage or loss
                        caused or
                    ...
                    <p>These Terms shall be governed and construed in accordance with the laws of Macedonia, without
                        regard
                    ...
                    <p>By continuing to access or use our Service after those revisions become effective, you agree to
                        be
                        bound by the revised terms. If you do not agree to the new terms, please stop using the
                        Service.</p>
