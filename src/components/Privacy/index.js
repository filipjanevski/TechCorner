        ...
        return (
            <div>
                ...
                <p>We use your data to provide and improve the Service. By using the Service, you agree to the
                    ...
                    Conditions, accessible from https://tech-corner.netlify.com/</p>
                ...
                <p>Tech Corner! uses the collected data for various purposes:</p>
                <ul>
                ...
                <p>If you are located outside Macedonia and choose to provide information to us, please note that we
                    transfer the data, including Personal Data, to Macedonia and process it there.</p>
                ...
                <p>Tech Corner! will take all steps reasonably necessary to ensure that your data is treated securely
                ...
                <p>Tech Corner! may disclose your Personal Data in the good faith belief that such action is necessary
                    to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of Tech Corner!</li>
                ...
                <ul>
                    <li>By email: filipj.mkd@gmail.com</li>
