        ...
        return (
            <div style={this.style} className="row">
                <div className="col-md-12">
                    ...
                    <p>Tech Corner! will take all steps reasonably necessary to ensure that your data is treated
                        securely
                    ...
                    <p>Tech Corner! may disclose your Personal Data in the good faith belief that such action is
                        necessary
                        to:</p>
                    <ul>
